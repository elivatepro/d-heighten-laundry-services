...
const serviceLinks = [
  ...
  { label: "Full Laundry Service", href: "/services#full-laundry" },
  { label: "Pressing Only", href: "/services#pressing" },
...
export function Footer() {
  return (
    <footer className="border-t border-brand-light-gray bg-[var(--color-dark-gray)]">
      <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-text-secondary">
              Professional laundry care for busy lives.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-text-secondary">
                ...
                <a href={`tel:${SITE_CONFIG.phoneRaw}`} className="hover:text-text-primary">
                  {SITE_CONFIG.phone}
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-text-secondary">
                <Mail size={16} className="mt-0.5 shrink-0 text-brand-blue" />
                <a href={`mailto:${SITE_CONFIG.email}`} className="break-all hover:text-text-primary">
                  {SITE_CONFIG.email}
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-text-secondary">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-brand-light-gray pt-8 md:flex-row">
          ...
          <p className="text-sm text-text-muted">
            ...
            <a
              href="https://bokoisaac.pro"
              target="_blank"
              rel="noopener noreferrer"
              className="text-text-secondary transition-colors hover:text-brand-yellow"
            >
              Boko Isaac
            </a>
          </p>
